...
public class DbHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String create = "CREATE TABLE tutors ( Name TEXT,Class1 TEXT, Locality TEXT, PastResults TEXT,  Image1 TEXT, Image2 TEXT, Image3 TEXT,Subject TEXT,PhoneNumber TEXT, Address TEXT, TeachingExperience TEXT, Review1 TEXT ,Review2 TEXT ,Rating TEXT )";
        db.execSQL(create);
    ...
    public  void addTutor(Tutors tutor){
        ...
        values.put("Review1",tutor.getReview1());
        values.put("Review2",tutor.getReview2());
        values.put("Rating",tutor.getRating());
    ...
    public boolean contains(Tutors tutor) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("SELECT * FROM tutors WHERE Name=?", new String[]{tutor.getName()});
