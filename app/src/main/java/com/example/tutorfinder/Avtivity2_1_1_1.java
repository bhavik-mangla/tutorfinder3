...
public class Avtivity2_1_1_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Review1 = findViewById(R.id.textView8);
        Review2 = findViewById(R.id.textView9);
        ...
        Review1.setText(bundle.getString("Review1"));
        Review2.setText(bundle.getString("Review2"));
