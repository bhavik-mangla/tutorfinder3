...
public class Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add("Nerul West, Mumbai");
        arrayList.add("Seawoods, Mumbai");
        arrayList.add("Vashi, Mumbai");
        arrayList.add("Dharavi, Mumbai");
        ...
        arrayList2.add("Mathematics-Trigonometry");
        arrayList2.add("Mathematics-Geometry");
        arrayList2.add("Mathematics-Algebra");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (textView.getText().toString()=="" || textView1.getText().toString()=="" || textView2.getText().toString() == ""){
                    ...
                    Intent intent = new Intent(Activity2.this, addTutors.class);
